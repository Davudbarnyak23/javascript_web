...
class PhotoGallery{
    constructor(){
        ...
        this.opendPhotoContainer = document.querySelector('.openedPhotoContainer')
    ...
    showCheckedPictures(){
        this.opendPhotoContainer.querySelector('.openedPhotoImg').src = picture.src
        this.opendPhotoContainer.querySelector('.openedPhotoImg').style.filter = picture.effect
        this.opendPhotoContainer.querySelector('.likesCount').innerText = picture.likes
        this.opendPhotoContainer.querySelector('.descriptionText').innerText = picture.description
    }
    initEventListeners(){
        this.pictureContainer.addEventListener('click', (e) => {
            if (e.target.classList.contains('pictureImg')){
                ...
                if (picture){
                    this.showCheckedPictures(picture);
                }
            }
        });

        this.cloneButton.addEventListener('click', (e) => {
            this.opendPhotoContainer.classList.add('hidden');
            this.opendPhotoContainer.innerText = '';
        })
    }
}
