...
//console.log(canvas)
const imgFloder = 'images/'

const bgImg = new Image()
bgImg.src = imgFloder + 'map01_preview-01.png';
...
class Player {
    constructor(x = 0, y = 0) {
        ...
        this.heroImg.src = imgFloder + 'idle_hero.png'
        this.heroMaxFrame = 17

        this.runLeftImg = new Image()
        this.runLeftImg.src = imgFloder + 'idle_runLeftImg.png'

        this.runRightImg = new Image()
        this.runRightImg.src = imgFloder + 'idle_runRightImg.png'
